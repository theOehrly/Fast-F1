...
##############################################################################
# Fetch the event schedule. Skip the first row, which is the pre-season test.
season = 2024
schedule = ff1.get_event_schedule(season).iloc[1:]
...
for _, event in schedule.iterrows():
    ...
    # For 2021 and 2022 season, this is called 'sprint'
    # For 2023, this is called 'sprint_shootout'
    sprint = None
