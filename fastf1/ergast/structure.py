...
def date_from_ergast(d_str) -> Optional[datetime.datetime]:
    ...
    try:
        ...
        logger.debug(
            f"Failed to parse date stamp '{d_str}' in Ergast" f"response."
        )
        return None
...
def time_from_ergast(t_str) -> Optional[datetime.time]:
    ...
    if res is None:
        logger.debug(
            f"Failed to parse timestamp '{t_str}' in Ergast" f"response."
        )
        return None
...
def _flatten_inline_list_of_dicts(
    nested: list,
    category: dict,
    flat: dict,
    *,
...
def _lap_timings_flatten_by_rename(
    nested: dict,
    category: dict,
    flat: dict,
    *,
...
FirstPractice = {
    ...
    "map": {
        "date": {"name": "fp1Date", "type": date_from_ergast},
...
SecondPractice = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "date": {"name": "fp2Date", "type": date_from_ergast},
...
ThirdPractice = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "date": {"name": "fp3Date", "type": date_from_ergast},
...
Qualifying = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "date": {"name": "qualifyingDate", "type": date_from_ergast},
...
Sprint = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "date": {"name": "sprintDate", "type": date_from_ergast},
...
FastestLapAvgSpeed = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "units": {"name": "fastestLapAvgSpeedUnits", "type": str},
...
FastestLap = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "rank": {"name": "fastestLapRank", "type": save_int},
...
Constructor = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "constructorId": {"name": "constructorId", "type": str},
...
Circuit = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "circuitId": {"name": "circuitId", "type": str},
...
QualifyingResults = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "number": {"name": "number", "type": save_int},
...
Seasons = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "season": {"name": "season", "type": save_int},
...
StandingsLists_Driver = {**__StandingsLists, "sub": [DriverStandings]}
...
Races_QualifyingResults = {**__Races, "sub": [Circuit, QualifyingResults]}

Races_SprintResults = {**__Races, "sub": [Circuit, SprintResults]}

Races_Laps = {**__Races, "sub": [Circuit, Laps]}

Races_PitStops = {**__Races, "sub": [Circuit, PitStops]}
...
Status = {
    ...
    "method": _flatten_by_rename,
    "map": {
        "statusId": {"name": "statusId", "type": save_int},
