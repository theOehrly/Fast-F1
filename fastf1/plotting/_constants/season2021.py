...
Teams: dict[str, TeamConst] = {
    "alfa romeo": TeamConst(
        ...
        TeamColor=TeamColorsConst(Official="#900000", FastF1="#900000"),
    ),
    "alphatauri": TeamConst(
        ShortName="AlphaTauri",
        TeamColor=TeamColorsConst(Official="#2b4562", FastF1="#2b4562"),
    ),
    "alpine": TeamConst(
        ShortName="Alpine",
        TeamColor=TeamColorsConst(Official="#0090ff", FastF1="#0755ab"),
    ),
    "aston martin": TeamConst(
        ShortName="Aston Martin",
        TeamColor=TeamColorsConst(Official="#006f62", FastF1="#00665e"),
    ),
    "ferrari": TeamConst(
        ShortName="Ferrari",
        TeamColor=TeamColorsConst(Official="#dc0004", FastF1="#dc0004"),
    ),
    "haas": TeamConst(
        ShortName="Haas",
        TeamColor=TeamColorsConst(Official="#ffffff", FastF1="#b6babd"),
    ),
    "mclaren": TeamConst(
        ShortName="McLaren",
        TeamColor=TeamColorsConst(Official="#ff9800", FastF1="#ff8000"),
    ),
    "mercedes": TeamConst(
        ShortName="Mercedes",
        TeamColor=TeamColorsConst(Official="#00d2be", FastF1="#00f5d0"),
    ),
    "red bull": TeamConst(
        ShortName="Red Bull",
        TeamColor=TeamColorsConst(Official="#0600ef", FastF1="#0600ef"),
    ),
    "williams": TeamConst(
        ShortName="Williams",
        TeamColor=TeamColorsConst(Official="#005aff", FastF1="#00a0dd"),
    ),
}
