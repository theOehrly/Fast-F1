...
Teams: dict[str, TeamConst] = {
    ...
    "alphatauri": TeamConst(
        ...
        TeamColor=TeamColorsConst(Official="#ffffff", FastF1="#2b4562"),
    ),
    "ferrari": TeamConst(
        ShortName="Ferrari",
    ...
    "haas": TeamConst(
        ShortName="Haas",
        TeamColor=TeamColorsConst(Official="#787878", FastF1="#b6babd"),
    ),
    "mclaren": TeamConst(
        ShortName="McLaren",
    ...
    "williams": TeamConst(
        ShortName="Williams",
        TeamColor=TeamColorsConst(Official="#0082fa", FastF1="#00a0dd"),
    ),
}
