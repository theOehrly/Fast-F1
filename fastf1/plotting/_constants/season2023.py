...
Teams: dict[str, TeamConst] = {
    "alfa romeo": TeamConst(
        ...
        TeamColor=TeamColorsConst(Official="#C92D4B", FastF1="#900000"),
    ),
    "alphatauri": TeamConst(
        ShortName="AlphaTauri",
        TeamColor=TeamColorsConst(Official="#5E8FAA", FastF1="#2b4562"),
    ),
    "alpine": TeamConst(
        ShortName="Alpine",
        TeamColor=TeamColorsConst(Official="#2293D1", FastF1="#fe86bc"),
    ),
    "aston martin": TeamConst(
        ShortName="Aston Martin",
        TeamColor=TeamColorsConst(Official="#358C75", FastF1="#00665e"),
    ),
    "ferrari": TeamConst(
        ShortName="Ferrari",
        TeamColor=TeamColorsConst(Official="#F91536", FastF1="#da291c"),
    ),
    "haas": TeamConst(
        ShortName="Haas",
    ...
    "mclaren": TeamConst(
        ShortName="McLaren",
        TeamColor=TeamColorsConst(Official="#F58020", FastF1="#ff8000"),
    ),
    "mercedes": TeamConst(
        ShortName="Mercedes",
        TeamColor=TeamColorsConst(Official="#6CD3BF", FastF1="#00f5d0"),
    ),
    "red bull": TeamConst(
        ShortName="Red Bull",
    ...
    "williams": TeamConst(
        ShortName="Williams",
        TeamColor=TeamColorsConst(Official="#37BEDD", FastF1="#00a0dd"),
    ),
}
