...
Teams: dict[str, TeamConst] = {
    "alfa romeo": TeamConst(
        ...
        TeamColor=TeamColorsConst(Official="#b12039", FastF1="#900000"),
    ),
    "alphatauri": TeamConst(
        ShortName="AlphaTauri",
        TeamColor=TeamColorsConst(Official="#4e7c9b", FastF1="#2b4562"),
    ),
    "alpine": TeamConst(
        ShortName="Alpine",
    ...
    "aston martin": TeamConst(
        ...
        TeamColor=TeamColorsConst(Official="#2d826d", FastF1="#00665e"),
    ),
    "ferrari": TeamConst(
        ShortName="Ferrari",
        TeamColor=TeamColorsConst(Official="#ed1c24", FastF1="#da291c"),
    ),
    "haas": TeamConst(
        ShortName="Haas",
    ...
    "red bull": TeamConst(
        ShortName="Red Bull",
        TeamColor=TeamColorsConst(Official="#1e5bc6", FastF1="#0600ef"),
    ),
    "williams": TeamConst(
        ShortName="Williams",
